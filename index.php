...
if($method == "1"){
  ...
  $sql = "DELETE FROM points WHERE email = '$email';";
  //echo "SQL query: " . $sql . "\n";
      ...
      <div class="card mt-5 px-3 py-4">
        ...
        <div class="media mt-4 pl-2">
          ...
          <div class="media-body">
            <h6 class="mt-1">Enter Your Number</h6>
          </div>
        </div>
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="amount" placeholder="Enter Amount" value="<?php print($total) ?>" readonly="">
                </div>
                <div class="col-12">
...
if($_POST['selected'] == 1){ //points not used 
  $email = $_SESSION['login'];  
  $sql = "DELETE  from points  where email = '$email';";
  $query = $dbh->prepare($sql);
  $response = $query->execute();
